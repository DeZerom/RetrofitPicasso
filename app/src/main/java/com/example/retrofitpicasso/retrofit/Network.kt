...
import com.example.retrofitpicasso.retrofit.blague.BlagueJokeService
import com.example.retrofitpicasso.retrofit.blague.BlagueResponse
...
class Network(application: Application) {
    ...
    private val blagueRetrofit: Retrofit
    ...
    private val blagueService by lazy { blagueRetrofit.create(BlagueJokeService::class.java) }
    ...
    @Suppress("UNCHECKED_CAST")
    private fun getBlagueJokeCall(): Call<NetJoke> {
        return blagueService.getRandomJoke() as Call<NetJoke>
    }
}